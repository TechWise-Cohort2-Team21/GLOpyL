...
glossary_button.place(relx=0, rely=0.12, relwidth=0.8, relheight=0.05)
...
fileTypeOptionMenu.place(relx=0, rely=0.19, relwidth=0.35, relheight=0.05)
saveButton = tk.Button(settings_frame, text="Save", command=saveFile, background="grey80")
saveButton.place(relx=0.45, rely=0.19, relwidth=0.35, relheight=0.05)
view_history_button = tk.Button(settings_frame, text="View History", command=view_history, background="grey80")
view_history_button.place(relx=0, rely=0.26, relwidth=0.8, relheight=0.05)
summary_model_label = tk.Label(settings_frame, text="Summary AI:")
summary_model_label.place(relx=0, rely=0.33, relwidth=0.35, relheight=0.05)
...
summary_model_dropdown.place(relx=0.45, rely=0.33, relwidth=0.35, relheight=0.05)
summary_button = tk.Button(settings_frame, text="Summarize Code", command=summarize_code, background="grey80")
summary_button.place(relx=0, rely=0.4, relwidth=0.8, relheight=0.05)
summary_textbox = tk.Text(settings_frame, height=0.5, wrap=tk.WORD)
summary_textbox.place(relx=0, rely=0.45, relwidth=0.8, relheight=0.45)
